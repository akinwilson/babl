...
class Data:
    ...
    data_path_root : Path = field(default=Path(__file__).parent , metadata={'help': "directory path containing fitting data. Should contain files: `10k.jsonl` and `50k.jsonl`"} )
####################################################################################
